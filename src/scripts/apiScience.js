            ...
            fetch(`https://api.nytimes.com/svc/topstories/v2/science.json?api-key=${KEY}`)
                ...
                .then(function (data) {
                    ...
                    data.results.forEach(object => {
                     ...
                     <button data-title="${object.title}" data-category="science" data-imageURL="${object.multimedia[2].url}" data-abstract="${object.abstract}" data-siteURL="${object.url}" class="archiveButton"><i class="archiveButton__icon fa-regular fa-bookmark"></i></button>
                    `
